...
def sheet(row):
    ...
    text(1780,980,'4 roof ribs + entry lead-in. Switch fit requires testing.',SMALL,MUTED,anchor='ma')
    ...
    text(620,1604,'TOTAL HEIGHT INCLUDING DECORATIVE RELIEF',MONO,anchor='ma')
    text(1780,1604,'PLAIN DECK / CHERRY R1 HEIGHT TARGET',MONO,anchor='ma')
    text(1780,1640,f"{sh:g} mm base + relief above / ~{row['wall_draft_deg']:.1f}° wall draft",SMALL,MUTED,anchor='ma')
